package org.desu.volley.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "volley@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "volley API";

        private String description = "volley API documentation";
